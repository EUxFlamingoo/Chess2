...
func show_promotion_ui(pawn_pos: Vector2, is_white: bool):
	...
	if is_white:
		UnitManager.white_2.visible = true
		UnitManager.white_3.visible = true
		UnitManager.white_4.visible = true
		UnitManager.white_5.visible = true
	else:
		UnitManager.black_2.visible = true
		UnitManager.black_3.visible = true
		UnitManager.black_4.visible = true
		UnitManager.black_5.visible = true
	UnitManager.promotion_position = pawn_pos
