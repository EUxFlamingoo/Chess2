...
func reset_game_state():
	...
	Rules.is_promotion_in_progress = false
	Rules.promotion_pawn = null
	Rules.promotion_position = null
	Rules.en_passant = Vector2(-1, -1)
	Rules.en_passant_capture_white = false
	Rules.en_passant_capture_black = false
	# Reset castling rights if you track them
	Rules.white_king_moved = false
	Rules.black_king_moved = false
	Rules.white_rook_queenside_moved = false
	Rules.white_rook_kingside_moved = false
	Rules.black_rook_queenside_moved = false
	Rules.black_rook_kingside_moved = false
